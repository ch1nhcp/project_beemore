              ...
              <div class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
                <div class="flex flex-wrap -mx-3 mb-6">
                  ...
                  <div class="w-full md:w-full px-3 mb-2 mt-2">
                    <textarea
                      class="bg-gray-100 resize-y rounded-md border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"
                      name="body"
